      ...
      <div className="name">
        <div className="textbox">
          ...
          <div className="home-buttons"> 
            ...
            <a href="http://locahost:3000/signup"><button className="signUp">Sign Up</button></a>

            <a href="http:localhost:3000/login"><button className="logIn">Log In</button></a>
          </div>
        </div>
        <img className="responsive" src="https://dionisopunk.files.wordpress.com/2018/11/the-circle-game-o.jpg?w=580&h=580&crop=1" alt="Ubuntu logo"></img>
      </div>
      <body>
      </body>
      <footer>
